...
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_hdpath_2.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_hdpath_1.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
...
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect.png"
      style={{ width: "666px", height: "362px" }}
    />
  </div>
</div>
...
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect_cosmos_1.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect_cosmos_2.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect_cosmos_3.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
...
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect_evm_1.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect_evm_2.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
<div style={{ display: "flex", justifyContent: "center", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_connect_evm_3.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
...
<div style={{ display: "flex", columnGap: "10px" }}>
  <div>
    <img
      src="/img/guide/extension/account/add/ledger_sign.png"
      style={{ width: "357px", height: "598px" }}
    />
  </div>
</div>
